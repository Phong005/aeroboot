...
/* Romfs support */
#define ROMFS_DRIVE             0x7A
#define CHS_FNT_LOAD_ADDR       RAW_ADDR ( 0x300000 )       // 中文字体位置, 约 1 MB
#define ENG_FNT_LOAD_ADDR       RAW_ADDR ( 0x3F0000 )       // 英文字体位置, 约 64kb
#define ROMFS_LOAD_ADDR         RAW_ADDR ( 0x400000 )       // romfs 位置
#define MAX_PATH                256
...
#define STAGE2_ID_ROMFS_STAGE1_5	12
...
# elif defined(FSYS_ROMFS)
#  define STAGE2_ID	STAGE2_ID_ROMFS_STAGE1_5
...
extern unsigned char * module_romfs_gz;
extern unsigned char * end_of_module_romfs_gz;
...
extern unsigned long romfs_drive;               // new for romfs support
#ifndef STAGE1_5
...
/////////////////////////////////// New for pkunzip support
// by Gandalf <ganstein@gmail.com>
#define true    1
#define false   0
