...
#if !defined(STAGE1_5) || defined(FSYS_ISO9660) || defined(FSYS_ROMFS)
int
...
#endif /* ! STAGE1_5 || FSYS_ISO9660  || defined(FSYS_ROMFS)*/
...
#if !defined(STAGE1_5) || defined(FSYS_VSTAFS) || defined(FSYS_ROMFS)
int
